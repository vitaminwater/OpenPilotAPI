...
} __attribute__((packed)) DataFieldsStabilizationSettingsBank2;

class StabilizationSettingsBank2: public UAVObject
{

public:
	int instance;
	DataFieldsStabilizationSettingsBank2 dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsStabilizationSettingsBank2);

    // Functions
    StabilizationSettingsBank2(UAVObjManager* manager);
    ...
    static StabilizationSettingsBank2* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
