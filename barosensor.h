...
} __attribute__((packed)) DataFieldsBaroSensor;

class BaroSensor: public UAVObject
{

public:
	int instance;
	DataFieldsBaroSensor dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsBaroSensor);

    // Functions
    BaroSensor(UAVObjManager* manager);
    ...
    static BaroSensor* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
