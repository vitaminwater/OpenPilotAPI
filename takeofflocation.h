...
} __attribute__((packed)) DataFieldsTakeOffLocation;

class TakeOffLocation: public UAVObject
{

public:
	int instance;
	DataFieldsTakeOffLocation dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsTakeOffLocation);

    // Functions
    TakeOffLocation(UAVObjManager* manager);
    ...
    static TakeOffLocation* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
