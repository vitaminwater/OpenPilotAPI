...
} __attribute__((packed)) DataFieldsMagSensor;

class MagSensor: public UAVObject
{

public:
	int instance;
	DataFieldsMagSensor dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsMagSensor);

    // Functions
    MagSensor(UAVObjManager* manager);
    ...
    static MagSensor* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
