...
int StabilizationSettingsBank1::numInstances = 0;

/**
 * Constructor
 */
StabilizationSettingsBank1::StabilizationSettingsBank1(UAVObjManager* manager): UAVObject(manager, 0xE8EBBD48, "StabilizationSettingsBank1", "Currently selected PID bank", "Control", 1, 1, ACCESS_READWRITE, ACCESS_READWRITE, 1, 1, UPDATEMODE_ONCHANGE, UPDATEMODE_ONCHANGE, 0, 0, 0)
{

}

int StabilizationSettingsBank1::UAVObjSetDataField(const char *dataIn, const std::string fieldID){
...
int StabilizationSettingsBank1::UAVObjGetDataField(char *dataOut, const std::string fieldID){
	if(fieldID == "ManualRate") {
...
int StabilizationSettingsBank1::UAVObjUnpack(const unsigned char *dataIn){
	memcpy(&dataFields, dataIn, NUMBYTES);
	return 0;
}

int StabilizationSettingsBank1::UAVObjPack(unsigned char *dataOut) {
	memcpy(dataOut, &dataFields, NUMBYTES);
	return 0;
}

unsigned short StabilizationSettingsBank1::UAVObjGetInstance() const {
	return instance;
}
unsigned short StabilizationSettingsBank1::UAVObjGetNumBytes() const {
	return sizeof(dataFields);
}
unsigned short StabilizationSettingsBank1::UAVObjGetNumInstances() const {
	return numInstances;
}

std::string StabilizationSettingsBank1::prettyPrint() {
	std::stringstream ss;
	ss << "\nPrinting object: stabilizationsettingsbank1" << std::endl;
...
/* */
/*UAVDataObject *StabilizationSettingsBank1::clone(unsigned int instID)*/
/*{*/
...
/* */
/*StabilizationSettingsBank1 *StabilizationSettingsBank1::GetInstance(UAVObjectManager *objMngr, unsigned int instID)*/
/*{*/
/*    return dynamic_cast<StabilizationSettingsBank1 *>(objMngr->getObject(StabilizationSettingsBank1::OBJID, instID));*/
/*}*/

/*float StabilizationSettingsBank1::getManualRate(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.ManualRate[index];
}
void StabilizationSettingsBank1::setManualRate(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank1::getMaximumRate(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.MaximumRate[index];
}
void StabilizationSettingsBank1::setMaximumRate(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank1::getRollRatePID(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.RollRatePID[index];
}
void StabilizationSettingsBank1::setRollRatePID(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank1::getPitchRatePID(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.PitchRatePID[index];
}
void StabilizationSettingsBank1::setPitchRatePID(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank1::getYawRatePID(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.YawRatePID[index];
}
void StabilizationSettingsBank1::setYawRatePID(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank1::getRollPI(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.RollPI[index];
}
void StabilizationSettingsBank1::setRollPI(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank1::getPitchPI(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.PitchPI[index];
}
void StabilizationSettingsBank1::setPitchPI(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank1::getYawPI(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.YawPI[index];
}
void StabilizationSettingsBank1::setYawPI(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank1::getThrustPIDScaleCurve(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.ThrustPIDScaleCurve[index];
}
void StabilizationSettingsBank1::setThrustPIDScaleCurve(unsigned int index, float value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank1::getRollMax() const
{
   QMutexLocker locker(mutex);
   return data.RollMax;
}
void StabilizationSettingsBank1::setRollMax(unsigned char value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank1::getPitchMax() const
{
   QMutexLocker locker(mutex);
   return data.PitchMax;
}
void StabilizationSettingsBank1::setPitchMax(unsigned char value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank1::getYawMax() const
{
   QMutexLocker locker(mutex);
   return data.YawMax;
}
void StabilizationSettingsBank1::setYawMax(unsigned char value)
{
   mutex->lock();
...
char StabilizationSettingsBank1::getStickExpo(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.StickExpo[index];
}
void StabilizationSettingsBank1::setStickExpo(unsigned int index, char value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank1::getEnablePiroComp() const
{
   QMutexLocker locker(mutex);
   return data.EnablePiroComp;
}
void StabilizationSettingsBank1::setEnablePiroComp(unsigned char value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank1::getEnableThrustPIDScaling() const
{
   QMutexLocker locker(mutex);
   return data.EnableThrustPIDScaling;
}
void StabilizationSettingsBank1::setEnableThrustPIDScaling(unsigned char value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank1::getThrustPIDScaleSource() const
{
   QMutexLocker locker(mutex);
   return data.ThrustPIDScaleSource;
}
void StabilizationSettingsBank1::setThrustPIDScaleSource(unsigned char value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank1::getThrustPIDScaleTarget() const
{
   QMutexLocker locker(mutex);
   return data.ThrustPIDScaleTarget;
}
void StabilizationSettingsBank1::setThrustPIDScaleTarget(unsigned char value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank1::getThrustPIDScaleAxes() const
{
   QMutexLocker locker(mutex);
   return data.ThrustPIDScaleAxes;
}
void StabilizationSettingsBank1::setThrustPIDScaleAxes(unsigned char value)
{
   mutex->lock();
