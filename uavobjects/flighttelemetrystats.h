...
} __attribute__((packed)) DataFieldsFlightTelemetryStats;

class FlightTelemetryStats: public UAVObject
{

public:
	int instance;
	DataFieldsFlightTelemetryStats dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsFlightTelemetryStats);

    // Functions
    FlightTelemetryStats(UAVObjManager* manager);
    ...
    static FlightTelemetryStats* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
