...
} __attribute__((packed)) DataFieldsAirspeedState;

class AirspeedState: public UAVObject
{

public:
	int instance;
	DataFieldsAirspeedState dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsAirspeedState);

    // Functions
    AirspeedState(UAVObjManager* manager);
    ...
    static AirspeedState* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
