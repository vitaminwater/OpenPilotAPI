...
} __attribute__((packed)) DataFieldsPoiLocation;

class PoiLocation: public UAVObject
{

public:
	int instance;
	DataFieldsPoiLocation dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsPoiLocation);

    // Functions
    PoiLocation(UAVObjManager* manager);
    ...
    static PoiLocation* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
