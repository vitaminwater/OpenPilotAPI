...
} __attribute__((packed)) DataFieldsFlightPlanControl;

class FlightPlanControl: public UAVObject
{

public:
	int instance;
	DataFieldsFlightPlanControl dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsFlightPlanControl);

    // Functions
    FlightPlanControl(UAVObjManager* manager);
    ...
    static FlightPlanControl* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
