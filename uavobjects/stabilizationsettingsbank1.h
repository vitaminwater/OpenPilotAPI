...
} __attribute__((packed)) DataFieldsStabilizationSettingsBank1;

class StabilizationSettingsBank1: public UAVObject
{

public:
	int instance;
	DataFieldsStabilizationSettingsBank1 dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsStabilizationSettingsBank1);

    // Functions
    StabilizationSettingsBank1(UAVObjManager* manager);
    ...
    static StabilizationSettingsBank1* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
