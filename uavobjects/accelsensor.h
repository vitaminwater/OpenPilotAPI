...
} __attribute__((packed)) DataFieldsAccelSensor;

class AccelSensor: public UAVObject
{

public:
	int instance;
	DataFieldsAccelSensor dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsAccelSensor);

    // Functions
    AccelSensor(UAVObjManager* manager);
    ...
    static AccelSensor* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
