...
} __attribute__((packed)) DataFieldsVelocityDesired;

class VelocityDesired: public UAVObject
{

public:
	int instance;
	DataFieldsVelocityDesired dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsVelocityDesired);

    // Functions
    VelocityDesired(UAVObjManager* manager);
    ...
    static VelocityDesired* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
