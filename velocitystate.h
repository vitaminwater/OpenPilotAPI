...
} __attribute__((packed)) DataFieldsVelocityState;

class VelocityState: public UAVObject
{

public:
	int instance;
	DataFieldsVelocityState dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsVelocityState);

    // Functions
    VelocityState(UAVObjManager* manager);
    ...
    static VelocityState* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
