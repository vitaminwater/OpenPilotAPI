...
int StabilizationSettingsBank2::numInstances = 0;

/**
 * Constructor
 */
StabilizationSettingsBank2::StabilizationSettingsBank2(UAVObjManager* manager): UAVObject(manager, 0x70E9539A, "StabilizationSettingsBank2", "Currently selected PID bank", "Control", 1, 1, ACCESS_READWRITE, ACCESS_READWRITE, 1, 1, UPDATEMODE_ONCHANGE, UPDATEMODE_ONCHANGE, 0, 0, 0)
{

}

int StabilizationSettingsBank2::UAVObjSetDataField(const char *dataIn, const std::string fieldID){
...
int StabilizationSettingsBank2::UAVObjGetDataField(char *dataOut, const std::string fieldID){
	if(fieldID == "ManualRate") {
...
int StabilizationSettingsBank2::UAVObjUnpack(const unsigned char *dataIn){
	memcpy(&dataFields, dataIn, NUMBYTES);
	return 0;
}

int StabilizationSettingsBank2::UAVObjPack(unsigned char *dataOut) {
	memcpy(dataOut, &dataFields, NUMBYTES);
	return 0;
}

unsigned short StabilizationSettingsBank2::UAVObjGetInstance() const {
	return instance;
}
unsigned short StabilizationSettingsBank2::UAVObjGetNumBytes() const {
	return sizeof(dataFields);
}
unsigned short StabilizationSettingsBank2::UAVObjGetNumInstances() const {
	return numInstances;
}

std::string StabilizationSettingsBank2::prettyPrint() {
	std::stringstream ss;
	ss << "\nPrinting object: stabilizationsettingsbank2" << std::endl;
...
/* */
/*UAVDataObject *StabilizationSettingsBank2::clone(unsigned int instID)*/
/*{*/
...
/* */
/*StabilizationSettingsBank2 *StabilizationSettingsBank2::GetInstance(UAVObjectManager *objMngr, unsigned int instID)*/
/*{*/
/*    return dynamic_cast<StabilizationSettingsBank2 *>(objMngr->getObject(StabilizationSettingsBank2::OBJID, instID));*/
/*}*/

/*float StabilizationSettingsBank2::getManualRate(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.ManualRate[index];
}
void StabilizationSettingsBank2::setManualRate(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getMaximumRate(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.MaximumRate[index];
}
void StabilizationSettingsBank2::setMaximumRate(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getRollRatePID(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.RollRatePID[index];
}
void StabilizationSettingsBank2::setRollRatePID(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getPitchRatePID(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.PitchRatePID[index];
}
void StabilizationSettingsBank2::setPitchRatePID(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getYawRatePID(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.YawRatePID[index];
}
void StabilizationSettingsBank2::setYawRatePID(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getRollPI(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.RollPI[index];
}
void StabilizationSettingsBank2::setRollPI(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getPitchPI(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.PitchPI[index];
}
void StabilizationSettingsBank2::setPitchPI(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getYawPI(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.YawPI[index];
}
void StabilizationSettingsBank2::setYawPI(unsigned int index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getThrustPIDScaleCurve(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.ThrustPIDScaleCurve[index];
}
void StabilizationSettingsBank2::setThrustPIDScaleCurve(unsigned int index, float value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank2::getRollMax() const
{
   QMutexLocker locker(mutex);
   return data.RollMax;
}
void StabilizationSettingsBank2::setRollMax(unsigned char value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank2::getPitchMax() const
{
   QMutexLocker locker(mutex);
   return data.PitchMax;
}
void StabilizationSettingsBank2::setPitchMax(unsigned char value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank2::getYawMax() const
{
   QMutexLocker locker(mutex);
   return data.YawMax;
}
void StabilizationSettingsBank2::setYawMax(unsigned char value)
{
   mutex->lock();
...
char StabilizationSettingsBank2::getStickExpo(unsigned int index) const
{
   QMutexLocker locker(mutex);
   return data.StickExpo[index];
}
void StabilizationSettingsBank2::setStickExpo(unsigned int index, char value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank2::getEnablePiroComp() const
{
   QMutexLocker locker(mutex);
   return data.EnablePiroComp;
}
void StabilizationSettingsBank2::setEnablePiroComp(unsigned char value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank2::getEnableThrustPIDScaling() const
{
   QMutexLocker locker(mutex);
   return data.EnableThrustPIDScaling;
}
void StabilizationSettingsBank2::setEnableThrustPIDScaling(unsigned char value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank2::getThrustPIDScaleSource() const
{
   QMutexLocker locker(mutex);
   return data.ThrustPIDScaleSource;
}
void StabilizationSettingsBank2::setThrustPIDScaleSource(unsigned char value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank2::getThrustPIDScaleTarget() const
{
   QMutexLocker locker(mutex);
   return data.ThrustPIDScaleTarget;
}
void StabilizationSettingsBank2::setThrustPIDScaleTarget(unsigned char value)
{
   mutex->lock();
...
unsigned char StabilizationSettingsBank2::getThrustPIDScaleAxes() const
{
   QMutexLocker locker(mutex);
   return data.ThrustPIDScaleAxes;
}
void StabilizationSettingsBank2::setThrustPIDScaleAxes(unsigned char value)
{
   mutex->lock();
