...
} __attribute__((packed)) DataFieldsPositionState;

class PositionState: public UAVObject
{

public:
	int instance;
	DataFieldsPositionState dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsPositionState);

    // Functions
    PositionState(UAVObjManager* manager);
    ...
    static PositionState* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
