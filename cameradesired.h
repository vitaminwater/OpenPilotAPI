...
} __attribute__((packed)) DataFieldsCameraDesired;

class CameraDesired: public UAVObject
{

public:
	int instance;
	DataFieldsCameraDesired dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsCameraDesired);

    // Functions
    CameraDesired(UAVObjManager* manager);
    ...
    static CameraDesired* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
