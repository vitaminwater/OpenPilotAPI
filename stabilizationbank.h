...
} __attribute__((packed)) DataFieldsStabilizationBank;

class StabilizationBank: public UAVObject
{

public:
	int instance;
	DataFieldsStabilizationBank dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsStabilizationBank);

    // Functions
    StabilizationBank(UAVObjManager* manager);
    ...
    static StabilizationBank* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
