...
} __attribute__((packed)) DataFieldsGPSVelocitySensor;

class GPSVelocitySensor: public UAVObject
{

public:
	int instance;
	DataFieldsGPSVelocitySensor dataFields;
    ...
    // Constants
    static const unsigned int NUMBYTES = sizeof(DataFieldsGPSVelocitySensor);

    // Functions
    GPSVelocitySensor(UAVObjManager* manager);
    ...
    static GPSVelocitySensor* GetInstance(UAVObjectManager* objMngr, unsigned int instID = 0);
